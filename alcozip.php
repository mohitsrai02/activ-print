<html>
<head><title>Alcozip</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <!--Nav end -->
        ...
        <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>><a class='lnk' href='fountain_solutions.php'>Fountain Solutions</a> >>Alcozip</div>
                        ...
                        <div class="row">
                                        <div class="container col-xl-6">
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Alcozip</center> </h1>
                                                  <br>
                                                  <h5>Characteristics</h5>
                                                  <br>
                                                  <p>• ACTIVE PRINT ALCOZIP is a unique replacement of IPA for use with fount solution in all alcohol dampening systems.
<br>
• Completely eliminates the use of alcohol; enables you to Go Green
<br>
• Compatible with all alcohol dampening systems; for universal application.
<br>
• Achieves fast clean-up and rapid attainment of ink-water balance for reduced start-up wastages.
<br>
• Effective biocidal system; for prolonged tray life & improved productivity.

                                                                <br>
                                                                <h5>Application</h5>
                                                                <br>
                                                                • The recommended dosing of 2-3% for full benefits<br>

• Dilution may be optimized within the range depending on usage conditions.<br>

• Ideal dilution will depend on press speed, type of dampening system, ink type and paper quality.<br>
<br>
                                                            <h5>Packaging</h5>
                                                            <br>
 
                                                            •  5/25 litre cans, 200 litre drums
