<html>
  <head><title>Fountain Solutions</title><link rel="icon" href="image/icon.png">
            <meta charset="utf-8">
...
<script type="text/javascript">
    $(function() {
        $('.multiselect-ui').multiselect({
           ...
           <link href="css/chemicals.css" rel="stylesheet" type="text/css">
           <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
            ...
            <body>   
              <div class="container">
                ...
                <!--Nav end -->
                <img class="sticky responsive" src="images/1475921492.jpg">
                
                <div class="container-fluid boot">
                <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>>Fountain Solutions</div>
                      
                  <h1>Fountain Solutions<hr width="100cm" color="red"></h1>
                  <br>
                  <br>
                  
          
                  <div class="row row1">
                  <div class="col-md-3 col-sm-3  col-xs-6 div1">
                      <a href="ultra.php">
                      <img src="images/Fat.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="ultra.php" style="color:white">
                          <h4>Ultra</h4>
                                </a>
                        </div>
                      </div>
                    ...
                    <div class=" col-md-3 col-sm-3  col-xs-6 div1" >
                            <a href="alcoplus_plus.php">
                        <img src="images/Fat.jpg" alt="Avatar" class="image"></a>
                        <div class="text-block">
                                <a href="alcoplus_plus.php" style="color:white">
                            <h4>Alcoplus+</h4>
                            </a>
                          </div>
                      </div>
                      ...
                      <div class=" col-md-3 col-sm-3  col-xs-6 div1 ">
                          ...
                          <img src="images/Fat.jpg" alt="Avatar" class="image"></a>
                          <div class="text-block">
                                <a href="perfect.php" style="color:white">
                              <h4>Perfect</h4>
                              </a>
                            </div>
                        </div>
                        <div class=" col-md-3 col-sm-3  col-xs-6 div1">
                            <a href="alcozip.php">
                        <img src="images/images_1.jpg" alt="Avatar" class="image"></a>
                        <div class="text-block col">
                                <a href="alcozip.php" style="color:white">
                            <h4>Alcozip</h4>
                           </a>
                          </div>
