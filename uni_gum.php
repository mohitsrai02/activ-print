<html>
<head><title>Gum Solutions</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <!--Nav end -->
        ...
        <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>><a href='plate_care_products.php' class='lnk'>Plate Care Products</a> >> Gum Solution</div>
                        <div class="row">
                                        <div class="container col-xl-6">
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Gum Solutions</center> </h1>
                                                  <br>
                                                  <h5>Product Usage</h5>
                                                  For long term gumming of offset plates.
                                                  <br><br>
                                                  <h5>Characteristics</h5>
                                                  <p>• Gum Arabic Solution with stabilizing additives.<br>

• For long term storage of plates.<br>

• Effective protection of the oxide surface.<br>

• Removable with water. <br>

                                                                <h5>Application</h5>
                                                                • Apply evenly onto plate manually or in the Plate Processor, Wash with water.
<br><br>
                                                            <h5>Packaging</h5>
                                                            • 5/20 litre can.
