<html>
  <head><title>Special Inks</title><link rel="icon" href="image/icon.png">
            <meta charset="utf-8">
           ...
           <link href="css/Inks.css" rel="stylesheet" type="text/css">
...
<!--Nav end --><img class="sticky responsive" src="images/68450968-water-drop-hd-wallpapers.jpeg">
                
                <div class="container-fluid boot">
               
<div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>> Special Inks</div>
                
                  <h1 style='color: #EA7624'>Special Inks<hr width="100cm" color="red"></h1>
                  <br>
                  <br>
                  
          
                  <div class="row row1">
                  <div class="col-md-4 col-sm-4  col-xs-6 div1">
                        <a href="silver_metallic_inks.php">
                      <img src="images/SILVER.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="silver_metallic_inks.php" style="color:white">
                          <h4>Metallic Inks</h4>
                      </a>
                        </div>
                      </div>
                      <div class="col-md-4 col-sm-4  col-xs-6 div1">
                        <a href="fluorescent_inks.php">
                      <img src="images/FLU1.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="fluorescent_inks.php" style="color:white">
                          <h4>Fluorescent Inks</h4>
                      </a>
                        </div>
                      </div>
                      <div class="col-md-4 col-sm-4  col-xs-6 div1">
                        <a href="pearl_inks.php">
                      <img src="images/PEARL.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="pearl_inks.php" style="color:white">
                          <h4>Pearl Inks</h4>
                      </a>
                        </div>
                      </div>
                      ...
                      <img src="images/offset-printing.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="miscellaneous.php" style="color:white">
                          <h4>Popular Inks</h4>
                      </a>
                        </div>
                      </div>
                      <div class="col-md-4 col-sm-4  col-xs-6 div1">
                        <a href="trans_over_print_inks.php">
                      <img src="images/offset-printing.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="trans_over_print_inks.php" style="color:white">
                          <h4>Trans. Over Print Inks</h4>
                      </a>
                        </div>
                      </div>
