<html>
  <head><title>Ink Additives</title><link rel="icon" href="image/icon.png">
            <meta charset="utf-8">
...
<!--Nav end -->
                <img class="sticky responsive" src="images/68450968-water-drop-hd-wallpapers.jpeg">
                
                <div class="container-fluid boot">
                                                    
                <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>>Ink Additives</div>
                
                  <h1>Ink Additives<hr width="100cm" color="red"></h1>
                  <br>
                  <br>
                  ...
                  <div class="col-md-4 col-sm-4  col-xs-6 div1">
                        <a href="tack_reducer_jelly.php">
                      <img src="images/offset-printing.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="tack_reducer_jelly.php" style="color:white">
                          <h4>Tack Reducers
                           </h4>
                      </a>
                        </div>
                      ...
                      <div class="col-md-4 col-sm-4  col-xs-6 div1">
                        <a href="gel_varnish.php">
                      <img src="images/OPV2.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="gel_varnish.php" style="color:white">
                          <h4>Ink Medium</h4>
                      </a>
                        </div>
                      </div>
                      <div class="col-md-4 col-sm-4  col-xs-6 div1">
                        <a href="combination_drier.php">
                      <img src="images/offset-printing.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="combination_drier.php" style="color:white">
                          <h4>Driers</h4>
                      </a>
                        </div>
                      </div>
