<html>
<head><title>Alcop++</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
      <a type="button" class="btn btn-info btn-lg" id="feedback" data-toggle="modal" onclick="window.location.href='interested.php'" data-target="#myModal">I'm Interested In</a>
    <!-- Modal -->
</div>
    <!-- Nav-->
    ...
    <!--Nav end -->
        <img class="sticky responsive" src="images/banner-our-products.jpg">
        <div class="container-fluid">
              
        <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>><a class='lnk' href='fountain_solutions.php'>Fountain Solutions</a> >>Alcoplus+</div>
                        
                        <div class="row">
                                        <div class="container col-xl-6">
                                            
                                            <img src="images/Fat.jpg" alt="Avatar" class="sticky1">
                                            
                                            </div>
                                          
                                                            
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Alcoplus+</center></h1>
                                                  <br>
                                                  <h5> Product Usage </h5>
                                                  <br>
                                                  <p>Fountain Solution Concentrate - with Alcohol Replacing Additives - for Sheet fed Offset Presses 
<br>
• Special alcohol replacement additives to eliminate the use of IPA 
<br>
• Prevents calcium deposits on ink rollers NO glazing and ink stripping 
<br>
• Stable ink and water balance safe printing process 
<br>
• Fast start up of the plate minimizes waste 

                                                                <br>
                                                                <h5>Application</h5>
                                                                <br>
                                                                • Dosage of AlcoPlus+: 3-4% depending on the water hardness for to reach a pH level of 4.5 – 5.5 <br>

• Dosage of IPA: 0-4% depending on the circumstances 
For a successful elimination of alcohol it is necessary: Fountain Solution Cooling System, standardized water quality, appropriate adjustment of the rollers, eventually ceramic or special rollers. If standard rollers are in use the duct speed might be increased considerable. This does not mean that more water is transferred and emulsified into the ink. 
<br>

• efore Fountain system must be cleaned properly. 
To convert alcohol dampening machine to alcohol free printing, use IPA for a week and gradually decrease the % of IPA every day and bring down to 0% 
<br>

                                                            <h5>Packaging</h5>
                                                            <br>
 
                                                            •  5 Litres, 25 Litres, 200 Litres
