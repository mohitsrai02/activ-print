<html>
<head><title>Pearl Inks</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>> <a href='special_inks.php' class='lnk'>Special Inks</a> >> Pearl Inks</div>
                
                        <div class="row">
                                        <div class="container col-xl-6">
                                            
                                            <img src="images/PEARL.jpg" alt="Avatar" class="sticky1">
                                          ...
                                          <div class="container col-xl-6">
                                                  ...
                                                  <h1 class="sticky"><center>Pearl Inks</center> </h1>
                                                  <br>
                                                  <h5>DISCRIPTION</h5>
                                                  <br>
