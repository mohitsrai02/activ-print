<html>
<head><title>Trans. Over Print Inks</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
      <a type="button" class="btn btn-info btn-lg" id="feedback" data-toggle="modal" onclick="window.location.href='interested.php'" data-target="#myModal">I'm Interested</a>
    <!-- Modal -->
</div>
    <!-- Nav-->
...
<div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>> <a href='special_inks.php' class='lnk'>Special Inks</a> >> Trans. Over Print Inks</div>
...
<a class="carousel-control-next" href="#demo" data-slide="next">
  <span class="carousel-control-next-icon"></span>
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Trans. Over Print Inks</center> </h1>
                                                  <br>
                                                  <h5>DISCRIPTION</h5>
                                                  <br>
