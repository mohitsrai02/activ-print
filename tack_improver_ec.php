<html>
<head><title>Track Improver Ec</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <!--Nav end -->
        ...
        <div class="container-fluid">              
                <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>><a class='lnk' href='ink_additives.php'>Ink Additives</a> >> Tack Improver Ec</div>
                        <div class="row">
                                        <div class="container col-xl-6">
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Tack Improver Ec</center> </h1>
                                                  <br>
                                                  <h5>DISCRIPTION</h5>
                                                  <br>
                                                           ...
                                                           <div class="row">
                                                                 <div class="col-sm-3">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                      ...
                                                                      <span class="acount-icon">          
                                                                      <a href="specia_inks.php"><i class="fa fa-glass" aria-hidden="true"></i>Special Inks</a>
