<html>
<head><title>Transparent White</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <!--Nav end -->
        ...
        <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>><a class='lnk' href='ink_additives.php'>Ink Additives</a> >> Transparent White</div>
                        ...
                        <div class="row">
                                        <div class="container col-xl-6">
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Transparent White</center> </h1>
                                                  <br>
                                                  <h5>DISCRIPTION</h5>
                                                  <br>
