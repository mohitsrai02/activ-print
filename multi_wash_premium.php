...
<html>
<head><title>Multi Wash Premium</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
                ...
                <br><br>
                        ...
                        <div class="row">
                                        <div class="container col-xl-6">
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Multi Wash Premium</center> </h1>
                                                  <br>
                                                  <h5>Product Usage</h5>
                                                  <br>
                                                  <p>• Blanket and Roller Wash-water miscible-for manual use.
                                                  <h5>Characteristics
</h5>
• High solvency power for a fast and thorough cleaning process<br>

• Flash point above 40°C<br>

• Water miscible – removes ink and paper dust in one step<br>

• Good evaporation without greasy residues-less waste<br>

• Added fragrance<br>

                                                                <h5>Application</h5>
                                                                <br>
                                                                • For manual cleaning, clean with a hand rag while ensuring to follow all press safety instructions.
<br>
