<html>
<head><title>Driers</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <!--Nav end -->
        ...
        <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>><a class='lnk' href='ink_additives.php'>Ink Additives</a> >> Driers</div>
...
<a class="carousel-control-next" href="#demo" data-slide="next">
  <span class="carousel-control-next-icon"></span>
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Driers</center> </h1>
                                                  <br>
                                                  <h5>DISCRIPTION</h5>
                                                  <br>
