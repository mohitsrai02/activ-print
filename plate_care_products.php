<html>
  <head><title>Plate Care Products</title><link rel="icon" href="image/icon.png">
            <meta charset="utf-8">
...
<!--Nav end -->
        ...
        <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>>Plate Care Products</div>
                        
                  <h1>Plate Care Products<hr width="100cm" color="red"></h1>
                  <br>
                  <br>
                  ...
                  <div class="col-md-3 col-sm-3  col-xs-6 div1">
                      <a href="plate_cleaner_gp.php">
                      <img src="images/Fat.jpg" alt="Avatar" class="image"></a>
                      <div class="text-block">
                            <a href="plate_cleaner_gp.php" style="color:white">
                          <h4>Plate Cleaners</h4>
                                </a>
                        </div>
                      </div>
                        ...
                        <div class="text-block col">
                                <a href="uni_gum.php" style="color:white">
                            <h4>Gum Solutions</h4>
                           </a>
                          </div>
