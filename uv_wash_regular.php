<html>
<head><title>Uv Wash Regular</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
                ...
                <br><br>
                        ...
                        <div class="row">
                                        <div class="container col-xl-6">
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Uv Wash Regular</center></h1>
                                                  <br>
                                                  <h5>Product Usage</h5>
                                                  Blanket Wash for manual blanket and roller cleaning. Specially recommended for EPDM rollers.
                                                  <br><br>
                                                  <h5>Characteristics</h5>
                                                  <p>• Mild aromatic solvent for UV inks<br>

• Good solvency power for a fast cleaning process<br>

• Good chemical compatibility with UV resistant rubber rollers and blankets<br>

• Flash point above 40°C<br>

• Water miscible – removes ink and paper<br>

• Very low odour<br>

                                                  
                                                  <h5>Application</h5>
                                                                • Manual cleaning with a hand rag. For blankets use undiluted ensure to follow all press safety instructions
<br><br>
                                                            <h5>Packaging</h5>
                                                            • 5/20 liter cans, 200 liters.
                                                           ...
                                                           <div class="row">
                                                                 <div class="col-sm-3">
                                                                    <h4 class="title"></h4>
                                                                        ...
                                                                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam, error. Minima repellendus corrupti in sapiente nemo nihil quae? Iure, sit. Quis nobis ducimus provident mollitia quibusdam nam modi qui iure!</p>
