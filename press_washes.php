<html>
<head><title>Press Wash</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>>Press Washes</div>
...
<a class="carousel-control-next" href="#demo" data-slide="next">
  <span class="carousel-control-next-icon"></span>
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Press Wash</center> </h1>
                                                  <br>
                                                  <h5>Characteristics</h5>
                                                  <br>
                                                  <p>• Based on aliphatic hydrocarbons<br>

• Good solvency power for a fast cleaning process<br>

• Corrosion inhibited – gentle to sensitive press parts<br>

• Flash point above 60°C<br>

• Very low rubber swelling effect – gentle to ink rollers and blankets<br>

• Water miscible – removes ink and paper dust<br>

• Very low odour<br>
                                                                <h5>Application</h5>
                                                                <br>
                                                                • Follow the automatic washing system‘s manufacturers operating instructions. If manual cleaning, then clean with a hand rag. Ensure to follow all press safety instructions.
 
<br>
