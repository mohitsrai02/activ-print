<html>
<head><title>Perfect Fount</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <!--Nav end -->
        ...
        <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>><a class='lnk' href='fountain_solutions.php'>Fountain Solutions</a> >>Perfect</div>
                        ...
                        <div class="row">
                                        <div class="container col-xl-6">
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Perfect</center> </h1>
                                                  <br>
                                                  <h5>Product Usage</h5>
                                                  <br>
                                                  <p>Fountain Solution Concentrate-alcohol reducing-for Sheet fed Offset Presses           <br>
                                                                <br>
                                                             <h5>Characteristics
</h5>
                                                                • Special alcohol reduction additives to reduce the IPA down to 3-6%.<br>

• Reduces calcium deposits on ink rollers. No glazing and ink stripping.<br>

• Reduction of water helps for faster drying of higher density of ink.<br>

• Very stable ink and water balance for consistent printing process.<br>

• Fast start up of the plate minimizes waste.<br>

• Reduces piling on blankets less wash down time.<br>

<h5>Application</h5>
<br>
Add 2-3% depending on the water hardness to reach a pH level of 4.5 – 5.5 
Fountain system must be cleaned properly before changing fount.
<br><br>
<h5>Packaging</h5><br>
20 litre cans, 200 litre drums
<br>
