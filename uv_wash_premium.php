<html>
<head><title>Uv Wash Premium</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
                ...
                <br><br>
                        ...
                        <div class="row">
                                        <div class="container col-xl-6">
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Uv Wash Premium</center> </h1>
                                                  <br>
                                                  <h5>Product Usage</h5>
                                                  Blanket Wash for Automatic Blanket Cleaning Systems and for manual use.
Recommended for EPDM rollers.
                                                  <br><br>
...
• Very low odour <br>
                                                                ...
                                                                <h5>Application</h5>
                                                                • In case of automatic washing system, follow the manufacturer’s operating instructions. If cleaning manually, then clean with a hand rag. For blankets, use undiluted. Follow all press safety instructions
<br><br>
                                                            <h5>Packaging</h5>
                                                            • 5/20 litre cans, 200 litre
