<html>
<head><title>Fluorescent Ink</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>> <a href='special_inks.php' class='lnk'>Special Inks</a> >> Fluorescent Ink</div>
...
<a class="carousel-control-next" href="#demo" data-slide="next">
  <span class="carousel-control-next-icon"></span>
                                          ...
                                          <div class="container col-xl-6">
                                                  ...
                                                  <h1 class="sticky"><center>Fluorescent Inks</center> </h1>
                                                  <br>
                                                  <h5>DISCRIPTION</h5>
                                                  <br>
