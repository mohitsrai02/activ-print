<html>
<head><title>Plate Cleaners</title><link rel="icon" href="image/icon.png">
 <meta charset="utf-8">
...
<body>
    ...
    <!--Nav end -->
        ...
        <div class='col-xl-12 address'>You are here : <a class='lnk' href='index.php'>Home </a>>><a href='plate_care_products.php' class='lnk'>Plate Care Products</a> >> Plate Cleaners</div>
                                                <div class="row">
...
<a class="carousel-control-next" href="#demo" data-slide="next">
  <span class="carousel-control-next-icon"></span>
                                          ...
                                          <div class="container col-xl-6">
                                                  <h1 class="sticky"><center>Plate Cleaners</center> </h1>
                                                  <br>
                                                  <h5>Product Usage</h5>
                                                  Cleaners for printing plates
                                                  <br><br>
                                                  <h5>Characteristics</h5>
                                                  <p>• Removes ink and slight background toning<br>

• Activates the oxide surface of the plate<br>

• Also removes dried ink and slight scratches<br>

• Fast evaporation without greasy residues<br>

                                                                <h5>Application</h5>
                                                                • 
Apply Plate Cleaner onto a rag of sponge and clean plate surface with a slight pressure
<br><br>
                                                            <h5>Packaging</h5>
                                                            • 1/5 Litre
                                                        </p>
